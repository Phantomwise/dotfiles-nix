...
# "${mod}+d" = "exec $menu";
	...
	# ╚══════════════════════════════════════════════════════════════╝
		...
		# Screenshot all screen to file named 'screenshot_date&hour.png'
			"Print" = "exec 'grim -t png $HOME/Pictures/Screenshots/Screenshot_$(date +'%Y-%m-%d_%H-%M-%S').png'";
			"${mod}+p" = "exec 'grim -t png $HOME/Pictures/Screenshots/Screenshot_$(date +'%Y-%m-%d_%H-%M-%S').png'";
